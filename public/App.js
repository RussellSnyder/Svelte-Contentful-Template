...
const css = {
	code: "img.svelte-1tbq7jr{width:100%;height:auto}.image-container.svelte-1tbq7jr{max-height:200px;overflow:hidden}",
	map: "{\"version\":3,\"file\":\"PostFeaturedImage.svelte\",\"sources\":[\"PostFeaturedImage.svelte\"],\"sourcesContent\":[\"<style>\\n    img {\\n        width: 100%;\\n        height: auto;\\n    }\\n    .image-container {\\n            max-height: 200px;\\n            overflow: hidden;\\n\\n    }\\n</style>\\n\\n<script>\\n\\texport let featuredImage;\\n\\texport let isPreview = false;\\n</script>\\n\\n<div class=\\\"image-container\\\">\\n    {#await featuredImage}\\n        <img class:isPreview={isPreview} src=\\\"https://picsum.photos/1000/300\\\" alt=\\\"placeholder\\\">\\n    {:then featuredImage}\\n        <img class:isPreview={isPreview} src={featuredImage.src} alt={featuredImage.title}>\\n    {/await}\\n</div>\\n\"],\"names\":[],\"mappings\":\"AACI,GAAG,eAAC,CAAC,AACD,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AAChB,CAAC,AACD,gBAAgB,eAAC,CAAC,AACV,UAAU,CAAE,KAAK,CACjB,QAAQ,CAAE,MAAM,AAExB,CAAC\"}"
};
...
const PostFeaturedImage = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="image-container svelte-1tbq7jr">
	    ${(function(__value) { if(is_promise(__value)) return `
	        <img src="https://picsum.photos/1000/300" alt="placeholder" class="${[`svelte-1tbq7jr`, isPreview ? "isPreview" : ""].join(' ').trim() }">
	    `; return function(featuredImage) { return `
	        <img${(v => v == null ? "" : ` src="${escape(featuredImage.src)}"`)(featuredImage.src)}${(v => v == null ? "" : ` alt="${escape(featuredImage.title)}"`)(featuredImage.title)} class="${[`svelte-1tbq7jr`, isPreview ? "isPreview" : ""].join(' ').trim() }">
...
const Home = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	${validate_component(Router, 'Router').$$render($$result, {}, {}, {
		default: () => `
	    ${each(posts, (post) => `${validate_component(Post, 'Post').$$render($$result, Object.assign(post, { isPreview: true }), {}, {})}`)}
	`
	})}
	`;}(__value);}(posts)) }`;
});
...
const Blog = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	${validate_component(Router, 'Router').$$render($$result, {}, {}, {
	  ...
	  <ul>
	    ${each(posts, (post) => `<li>${validate_component(Link, 'Link').$$render($$result, { to: post.slug }, {}, { default: () => `${escape(post.title)}` })}</li>`)}
	  </ul>
